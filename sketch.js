    ...
    if (imgLoaded && images.length > 0) {      
      ...
      pop();
        ...
        if (poses.length > 0) {
          ...
          let wordsT = createGraphics(torsoD*2, dist(leftShoulder.x, leftShoulder.y, rightShoulder.x, rightShoulder.y)/2 )
          wordsT.scale(-1, 1);
          ...
          let wordsUA = createGraphics(upperArmSize*2, dist(leftShoulder.x, leftShoulder.y, leftElbow.x, leftElbow.y)/2 )
          ...
          let wordsLA = createGraphics(lowerArmSize*2, dist(leftElbow.x, leftElbow.y, leftWrist.x, leftWrist.y)/2 )
          ...
          let wordsUL = createGraphics(upperLegSize*2, dist(leftShoulder.x, leftShoulder.y, rightShoulder.x, rightShoulder.y)/2 )
          wordsUL.scale(-1, 1);
          ...
          let wordsLL = createGraphics(lowerLegSize*2, dist(leftShoulder.x, leftShoulder.y, rightShoulder.x, rightShoulder.y)/2 )
          wordsLL.scale(-1, 1);
